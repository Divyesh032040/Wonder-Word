...
import authService from '../AppWrite/Auth';
import { useForm } from 'react-hook-form';
import './Login.css'; // Create and import this CSS file for animations.
...
function Login() {
    ...
    return (
        <div className='relative flex items-center justify-center w-full h-full bg-animation'>
            {/* Animated background */}
    ...
    <div className="star"></div>
            ...
            {/* Login Form */}
            {/* <div className="relative z-10 m-6 mx-auto w-full max-w-lg bg-gray-200 p-10 rounded-xl border border-black/10 shadow-lg">
                <div className="mb-2 flex justify-center">
                    <span className="inline-block w-full max-w-[300px]">
                        <h1 className=' text-black text-center text-3xl border-neutral-800 font-bold '>
                            WonderWord
                ...
                <div className="relative z-10 m-4 sm:m-6 mx-auto w-full max-w-lg bg-gray-200 p-6 sm:p-10 rounded-xl border border-black/10 shadow-lg">
    <div className="mb-2 flex justify-center">
        <span className="inline-block w-full max-w-[300px]">
            <h1 className='text-black text-center text-3xl border-neutral-800 font-bold'>
                WonderWord
    ...
    <form onSubmit={handleSubmit(handleLogin)} className='mt-8 p-4 sm:p-6 bg-gray-800 rounded-lg shadow-lg'>
        <div className='space-y-5'>
            <div className='flex flex-col'>
                <label className='text-gray-300 mb-2 font-medium'>{`Email:`}</label>
                <Input
